...
def json_getir_bugun(sehir):
    api_key = "edc6301849045530495550d13bf76c7b"
    api_url = "http://api.openweathermap.org/data/2.5/weather?q={}&appid={}".format(sehir, api_key)
    r = requests.get(api_url)
    return r.json()

def kelvin_donusturucu(sicaklik):
    sicaklik_celsius = sicaklik - 273.15
    sicaklik_celsius = round(sicaklik_celsius, 1)
    return sicaklik_celsius
